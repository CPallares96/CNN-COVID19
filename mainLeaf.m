...
col = z(:,2);
v = z(:,3);
w3 = sparse(row, col, v,15876,15376);
...
col = z(:,2);
v = z(:,3);
w4 = sparse(row, col, v,16384,15876);



a5=sparse(im2double(imagenVec));
a4=reLu(sparse(a5*w4));
a3=0.03*reLu(sparse(a4*w3));
